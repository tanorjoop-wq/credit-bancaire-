...
$racineAutorisee = realpath(__DIR__ . '/../../storage/documents');

// Empêche toute traversée de répertoire (../) en dehors du dossier documents autorisé
if ($cheminReel === false || strpos($cheminReel, $racineAutorisee) !== 0 || !is_file($cheminReel)) {
    http_response_code(404);
    die('Fichier introuvable.');
}

enregistrerAudit('TELECHARGEMENT_DOCUMENT', 'documents', $idDocument, 'Téléchargement de "' . $document['nom_fichier'] . '"');
